...
- `BEVY-006` (`IN_PROGRESS`): close remaining physics3d parity gaps from the matrix (`joint behavior`, `cast-shape query matrix`, `character controller scenarios`).
