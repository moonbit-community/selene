...
Last updated: 2026-04-01 (physics3d threshold + graph canvas edge-connect pass)
...
- `BEVY-006` (`IN_PROGRESS`): close remaining physics3d parity gaps from the matrix (`joint behavior assertions`, `character controller scenarios`).
