...
- `BEVY-006` (`IN_PROGRESS`): close remaining physics3d parity gaps from the matrix (`joint behavior`, `character controller scenarios`, `kinematic/sensor edge query scenarios`).
